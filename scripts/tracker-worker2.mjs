...
const VERSION = "v10.13-fresh-active-db";
...
function pruneActiveRecords(records){
  return (records||[]).filter(isFreshActionableNowRecord).sort((a,b)=>new Date(b.lastUpdated||0)-new Date(a.lastUpdated||0)).slice(0,80);
}
