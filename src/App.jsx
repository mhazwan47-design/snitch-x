...
function TradeActionCenter({ records, investments, onMarkInvestment }){
  ...
  return (
    <section className="trade-center">
      <div className="lab-head">
        <div>
          <p className="eyebrow">Trade Action Center · v10.11 All Links Fix</p>
...
export default function App(){
  ...
  function exp(){const blob=new Blob([JSON.stringify({version:"v10.11-all-links-route-fix",exportedAt:new Date().toISOString(),records:ref.current},null,2)],{type:"application/json"});const url=URL.createObjectURL(blob);const a=document.createElement("a");a.href=url;a.download="snitch-x-v10-11-all-links-route-fix.json";a.click();URL.revokeObjectURL(url)}
  ...
  return <main><header className="hero"><div><p className="eyebrow">SNITCH X · All Links Route Fix v10.11</p><h1>All Binance links corrected across every tab.</h1><p className="sub">V10.11 applies Direct/Mirror/Chart routing inside Trade Action Center, Investment Diary, Manual Add and copied plans.</p></div><div className="hero-card sync-card">
      <span>Status</span>
