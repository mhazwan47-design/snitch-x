...
function App(){
  ...
  function exp(){const blob=new Blob([JSON.stringify({version:"v10.14-extreme-hunter-full",exportedAt:new Date().toISOString(),records:ref.current},null,2)],{type:"application/json"});const url=URL.createObjectURL(blob);const a=document.createElement("a");a.href=url;a.download="snitch-x-v10-14-extreme-hunter-full.json";a.click();URL.revokeObjectURL(url)}
  ...
  return <main><header className="hero"><div><p className="eyebrow">SNITCH X · Extreme Hunter Full v10.14</p><h1>Aggressive opportunity hunter + capital deployment plan.</h1><p className="sub">V10.14 expands coin universe, adds Extreme Hunter labels and builds a capital attack plan while keeping fresh-list cleanup.</p></div><div className="hero-card sync-card">
      <span>Status</span>
