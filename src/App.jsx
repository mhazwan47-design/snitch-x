...
export default function App(){
  ...
  function exp(){const blob=new Blob([JSON.stringify({version:"v10.14.4-stable-ui-recovery",exportedAt:new Date().toISOString(),records:ref.current},null,2)],{type:"application/json"});const url=URL.createObjectURL(blob);const a=document.createElement("a");a.href=url;a.download="snitch-x-v10-14-4-stable-ui-recovery.json";a.click();URL.revokeObjectURL(url)}
  ...
  return <main><header className="hero"><div><p className="eyebrow">SNITCH X · Stable UI Recovery v10.14.4</p><h1>Stable UI recovered. Expanded worker active. Fresh valid list only.</h1><p className="sub">V10.14.4 uses the last stable UI with expanded backend scanner/fallback. Plan Builder will be re-added after UI is confirmed stable.</p></div><div className="hero-card sync-card">
      <span>Status</span>
