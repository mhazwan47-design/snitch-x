...
function TradeActionCenter({ records }){
  ...
  return (
    <section className="trade-center">
      <div className="lab-head">
        <div>
          <p className="eyebrow">Trade Action Center · v10.5 Aggressive</p>
          <h2>Aggressive grab list + route advisor</h2>
          <p className="muted">
            Prioritizes GRAB NOW, ENTER SMALL and SCOUT ENTRY. Manual execution only; set stop-loss immediately.
          </p>
        </div>
...
export default function App(){
  ...
  return <main><header className="hero"><div><p className="eyebrow">SNITCH X · Aggressive Priority Mode v10.5</p><h1>Grab-ranked opportunities with aggressive position sizing.</h1><p className="sub">V10.5 ranks GRAB NOW, ENTER SMALL and SCOUT ENTRY with suggested size.</p></div><div className="hero-card sync-card">
      <span>Status</span>
