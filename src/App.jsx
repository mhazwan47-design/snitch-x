...
export default function App(){
  ...
  function exp(){const blob=new Blob([JSON.stringify({version:"v10.12-valid-list-cleanup",exportedAt:new Date().toISOString(),records:ref.current},null,2)],{type:"application/json"});const url=URL.createObjectURL(blob);const a=document.createElement("a");a.href=url;a.download="snitch-x-v10-12-valid-list-cleanup.json";a.click();URL.revokeObjectURL(url)}
  ...
  return <main><header className="hero"><div><p className="eyebrow">SNITCH X · Valid List Cleanup v10.12</p><h1>Only valid active setups, success records and diary are kept.</h1><p className="sub">V10.12 removes invalid, stale, past-target and failed records from Scanner, Trade Action Center and Performance Lab.</p></div><div className="hero-card sync-card">
      <span>Status</span>
