...
export default function App(){
  ...
  function exp(){const blob=new Blob([JSON.stringify({version:"v10.13-fresh-active-db",exportedAt:new Date().toISOString(),records:ref.current},null,2)],{type:"application/json"});const url=URL.createObjectURL(blob);const a=document.createElement("a");a.href=url;a.download="snitch-x-v10-13-fresh-active-db.json";a.click();URL.revokeObjectURL(url)}
  ...
  return <main><header className="hero"><div><p className="eyebrow">SNITCH X · Fresh Active DB v10.13</p><h1>Only valid active setups, success records and diary are kept.</h1><p className="sub">V10.13 hard-resets active records on every sync/run. Only fresh valid active setups, success forecast and diary are retained.</p></div><div className="hero-card sync-card">
      <span>Status</span>
